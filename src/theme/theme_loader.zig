...
const JsonColors = struct {
    ...
    tab_active_bg: ?[]const u8 = null,
    tab_inactive_bg: ?[]const u8 = null,
    tab_hover_bg: ?[]const u8 = null,
    tab_text: ?[]const u8 = null,
    tab_text_inactive: ?[]const u8 = null,
    tab_border: ?[]const u8 = null,
    tab_close_hover: ?[]const u8 = null,
    sidebar_bg: ?[]const u8 = null,
    sidebar_text: ?[]const u8 = null,
    sidebar_active_bg: ?[]const u8 = null,
    sidebar_hover_bg: ?[]const u8 = null,
    sidebar_border: ?[]const u8 = null,
    sidebar_indent_line: ?[]const u8 = null,
    alert_note_border: ?[]const u8 = null,
    alert_note_text: ?[]const u8 = null,
    alert_tip_border: ?[]const u8 = null,
    alert_tip_text: ?[]const u8 = null,
    alert_important_border: ?[]const u8 = null,
    alert_important_text: ?[]const u8 = null,
    alert_warning_border: ?[]const u8 = null,
    alert_warning_text: ?[]const u8 = null,
    alert_caution_border: ?[]const u8 = null,
    alert_caution_text: ?[]const u8 = null,
...
pub fn loadFromJson(allocator: Allocator, json_data: []const u8) !Theme {
    ...
    if (json.colors) |c| {
        ...
        theme.tab_bar_bg = colorOrDefault(c.tab_bar_bg, def.tab_bar_bg);
        theme.tab_active_bg = colorOrDefault(c.tab_active_bg, def.tab_active_bg);
        theme.tab_inactive_bg = colorOrDefault(c.tab_inactive_bg, def.tab_inactive_bg);
        theme.tab_hover_bg = colorOrDefault(c.tab_hover_bg, def.tab_hover_bg);
        theme.tab_text = colorOrDefault(c.tab_text, def.tab_text);
        theme.tab_text_inactive = colorOrDefault(c.tab_text_inactive, def.tab_text_inactive);
        theme.tab_border = colorOrDefault(c.tab_border, def.tab_border);
        theme.tab_close_hover = colorOrDefault(c.tab_close_hover, def.tab_close_hover);
        theme.sidebar_bg = colorOrDefault(c.sidebar_bg, def.sidebar_bg);
        theme.sidebar_text = colorOrDefault(c.sidebar_text, def.sidebar_text);
        theme.sidebar_active_bg = colorOrDefault(c.sidebar_active_bg, def.sidebar_active_bg);
        theme.sidebar_hover_bg = colorOrDefault(c.sidebar_hover_bg, def.sidebar_hover_bg);
        theme.sidebar_border = colorOrDefault(c.sidebar_border, def.sidebar_border);
        theme.sidebar_indent_line = colorOrDefault(c.sidebar_indent_line, def.sidebar_indent_line);
        theme.alert_note_border = colorOrDefault(c.alert_note_border, def.alert_note_border);
        theme.alert_note_text = colorOrDefault(c.alert_note_text, def.alert_note_text);
        theme.alert_tip_border = colorOrDefault(c.alert_tip_border, def.alert_tip_border);
        theme.alert_tip_text = colorOrDefault(c.alert_tip_text, def.alert_tip_text);
        theme.alert_important_border = colorOrDefault(c.alert_important_border, def.alert_important_border);
        theme.alert_important_text = colorOrDefault(c.alert_important_text, def.alert_important_text);
        theme.alert_warning_border = colorOrDefault(c.alert_warning_border, def.alert_warning_border);
        theme.alert_warning_text = colorOrDefault(c.alert_warning_text, def.alert_warning_text);
        theme.alert_caution_border = colorOrDefault(c.alert_caution_border, def.alert_caution_border);
        theme.alert_caution_text = colorOrDefault(c.alert_caution_text, def.alert_caution_text);
