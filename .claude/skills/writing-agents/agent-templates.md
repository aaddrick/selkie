...
zig build run -- file  # Run with input
```
...
## Selkie-Specific Examples

Potential agent roles for the Selkie project:

- **zig-developer** — Specialist in Zig idioms, memory management, C FFI with cmark-gfm
- **mermaid-specialist** — Expert on Mermaid diagram parsing, models, layout algorithms, renderers
- **layout-engineer** — Focused on document layout engine, text measurement, positioning
- **renderer-specialist** — raylib rendering, viewport culling, font scaling, draw calls
- **theme-designer** — Theme system, JSON loader, color definitions
